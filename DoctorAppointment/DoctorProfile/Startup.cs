...
using DoctorAppointment.DoctorProfile.BusinessLayer;
using DoctorAppointment.DoctorProfile.Common.Models;
namespace DoctorAppointment.DoctorProfile
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<DataContext>(opt => opt.UseInMemoryDatabase("DoctorProfileDB"));
            services.Configure<List<SpecialityModel>>(Configuration.GetSection("Speciality"));
            services.AddScoped<IDoctorProfile, Profile>();
